					...
					CTAP_credentialDescriptor *cred)
{
	...
	// Credential IDs from other authenticators may be larger than those
	// generated by this authenticator. Ignore oversized IDs
	buflen = sizeof(CredentialId);
	size_t sz = 0;
	cbor_ret = cbor_value_calculate_string_length(&val, &sz);
	cbor_check_ret(cbor_ret);
