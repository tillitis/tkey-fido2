 ...
 */
#define PROFILE_END(msg) fido2_log_profile_indent_level--; \
    LOG_PROFILE(msg, fido2_log_profile_indent_level, millis() - fido2_log_profile_start_time, __FILE__, fido2_log_profile_start_line, __LINE__); \
}
